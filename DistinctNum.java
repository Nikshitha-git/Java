/*
There are N number of small cartoons and each cartoon will have a balloon of some color identified by a number. You are asked to select fixed number of P-cartoons as a subset every time and find the number of unique colored 
...
class DistinctNum
{
    ...
    public static void findDistinctNumbersCount(int[] A, int k)
    {
        ...
        for (int i = 0; i < A.length; i++)
        {
			...
			// System.out.println("freq inside is "+freq);
